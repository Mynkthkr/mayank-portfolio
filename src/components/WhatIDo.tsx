        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing highly scalable and reliable infrastructure. Provisioning and orchestrating resources across multiple cloud providers.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">ECS / EKS</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS</h3>
              <h4>CI/CD & Observability</h4>
              <p>
                Streamlining deployment processes via robust CI/CD pipelines and ensuring comprehensive observability through advanced monitoring.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">GoCD / ArgoCD</div>
                <div className="what-tags">Fluentbit</div>
